...
float g_diffuse, g_ambient, g_specular;
float g_diffuse2, g_ambient2, g_specular2;
...
GLvoid drawScene ( GLvoid )
{
	...
	World3D::Instance()->SetLightColor(0, GL_DIFFUSE, 0, 0, g_diffuse, 1);
	World3D::Instance()->SetLightColor(0, GL_AMBIENT, 0, 0, g_ambient, 1);
	World3D::Instance()->SetLightColor(0, GL_SPECULAR, 0, 0, g_specular, 1);

	World3D::Instance()->SetLightColor(1, GL_DIFFUSE, g_diffuse2, 0, 0, 1);
	World3D::Instance()->SetLightColor(1, GL_AMBIENT, g_ambient2, 0, 0, 1);
	World3D::Instance()->SetLightColor(1, GL_SPECULAR, g_specular2, 0, 0, 1);


	World3D::Instance()->SetLightPos(0, 0, 300, 200, 1);
	World3D::Instance()->SetLightPos(1, 0, 300, -200, 1);

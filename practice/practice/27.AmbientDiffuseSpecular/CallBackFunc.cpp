...
{
	init();
	World3D::Instance()->SetLightColor(0, GL_DIFFUSE, g_diffuse, g_diffuse, g_diffuse, 1);
	World3D::Instance()->SetLightColor(0, GL_AMBIENT, g_ambient, g_ambient, g_ambient, 1);
	World3D::Instance()->SetLightColor(0, GL_SPECULAR, g_specular, g_specular, g_specular, 1);

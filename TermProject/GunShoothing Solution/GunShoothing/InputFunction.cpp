...
void mouseFunc(int button, int state, int x, int y)
{
	if((button == GLUT_LEFT && state == GLUT_DOWN)){
		...
		GLOBAL.realMousePoint.x = temp_x;
		GLOBAL.realMousePoint.y = temp_y;
		GLOBAL.realMousePoint.z = temp_z;

		std::cout << GLOBAL.realMousePoint.x << ", " 
			<< GLOBAL.realMousePoint.y << ", "
			<< GLOBAL.realMousePoint.z << std::endl;

		WORLD.pickingCheck(GLOBAL.realMousePoint);
